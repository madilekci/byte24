  ...
  return (
    <div className={cn("flex flex-col gap-2", containerClassName)}>
      ...
      >
        ...
        {children ? (
          ...
          <div className="text-sm font-medium">
            Drop {props.multiple !== false ? "de bestanden" : "een bestand"}{" "}
            hier!
          </div>
        ) : (
          <div className="flex flex-col items-center gap-1.5">
            <div className="flex flex-row items-center gap-0.5 text-sm font-medium">
              ...
              {props.multiple !== false ? "bestanden" : "een bestand"}
            </div>
            {props.maxSize && (
      ...
      {showFilesList && files.length > 0 && (
        <div
          className={`flex w-full flex-col gap-2 ${files.length > 2 ? "h-48" : "h-fit"} mt-2 ${files.length > 0 ? "pb-2" : ""}`}
        >

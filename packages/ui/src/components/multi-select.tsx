  ...
  return (
    <PopoverTrigger asChild>
      <Button
        ...
        className={cn(
          "flex h-auto min-h-9 w-fit items-center justify-between gap-2 overflow-hidden rounded-md border border-input bg-transparent px-3 py-1.5 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 data-[placeholder]:text-muted-foreground dark:bg-input/30 dark:hover:bg-input/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground pointer-events-auto relative z-10",
          className
        )}
      >
        {children}
...
export function MultiSelectContent({
  ...
  return (
    <>
      ...
      <PopoverContent
        className="min-w-[var(--radix-popover-trigger-width)] p-0 z-50 pointer-events-auto"
...
export function MultiSelectItem({
  ...
  return (
    <CommandItem
      ...
      className={cn("cursor-pointer pointer-events-auto", props.className)}
    >
      <CheckIcon

        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto pointer-events-auto relative z-10",
          ...
          <PopoverContent
            ...
            className={cn(
              "w-auto p-0 z-50 pointer-events-auto",
